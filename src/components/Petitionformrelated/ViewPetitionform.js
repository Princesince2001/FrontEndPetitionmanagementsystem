...
const Userviewpetition = () => {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5112/api/Userpetition/GetByIndividualUser/api/GetIndividual/"+Cookies.get("Id")
        );
        setPosts(response.data);
...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid">
    <h1 class="navbar-brand" href="#" style={{fontSize:"x-large"}}>Delete Petition</h1>
  </div>
</nav>
<div className="App">
...
//                 />
// <div className="card-body">
// <h5 className="card-title">Petition Id: {post.id}</h5>
// <h6 className="card-subtitle mb-2 text-muted">
//                     Description: {post.petitionDescription}
// </h6>
// <p className="card-text">
